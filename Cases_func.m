...
plot(real(temp2(P.logic_ind_acc(1, :))), imag(temp2(P.logic_ind_acc(1, :))), 'go')
temp3 = P.deltaSigma_acc(3, :);
plot(real(temp3(P.logic_ind_acc(1, :))), imag(temp3(P.logic_ind_acc(1, :))), 'bo')
temp4 = P.deltaSigma_acc(4, :);
plot(real(temp4(P.logic_ind_acc(1, :))), imag(temp4(P.logic_ind_acc(1, :))), 'ko')
